...
export const getUserMetricById = async (metricId) => {
  try {
    const response = await axios.get(`${baseUrl()}/api/auth/userMetrics/${metricId}`);
...
export const updateUserMetric = async (metricId, data) => {
  try {
    const response = await axios.put(`${baseUrl()}/api/auth/userMetrics/${metricId}`, data);
    return response.data;
  } catch (error) {
...
export const deleteUserMetric = async (metricId) => {
  try {
    const response = await axios.delete(`${baseUrl()}/api/auth/userMetrics/${metricId}`);
    return response.data;
  } catch (error) {
